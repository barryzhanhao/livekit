...
type Router interface {
	...
	// Participant-level routing — allows a room's participants to span multiple nodes
	SetParticipantNode(ctx context.Context, roomName livekit.RoomName, participantID livekit.ParticipantID, nodeID livekit.NodeID) error
